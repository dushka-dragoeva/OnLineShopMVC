...
{
    public class BrandDescription_Should
    {
        [Test]
        public void HaveCorrectMinLength()
        {
            // Arrange
            var nameProperty = typeof(Brand).GetProperty("Description");
        ...
        {
            // Arrange & Act
            var brand = new Brand() { Description = testDescription };

            // Assert
            Assert.AreEqual(brand.Description, testDescription);
        }
    }
}
